<template>
  <DashboardLayout>
    ...
    <template #description>
      Ajoutez un nouveau commentaire à la plateforme
    </template>
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
          <div class="flex items-center">
            ...
            <h1 class="text-xl font-semibold text-gray-900">Nouveau commentaire</h1>
          </div>
        </div>
        ...
        <form @submit.prevent="submit" class="p-6">
          ...
          <div class="flex flex-wrap gap-3 justify-end pt-6 mt-6 border-t border-gray-200">
            ...
            >
              ...
              <span v-else>Créer le commentaire</span>
            </button>
          </div>
        </form>
      </div>
...
function submit() {
  form.post(route('commentaires.store'));
}
</script>
